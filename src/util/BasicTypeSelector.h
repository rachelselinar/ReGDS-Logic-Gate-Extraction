...
#ifndef __BASICTYPESELECTOR_H__
#define __BASICTYPESELECTOR_H__
...
template <> struct RankType<7> { using type = std::int64_t; };
...
/// Class to choose between two types
